...
export class IntelligentDocumentDiscovery {
  ...
  async findAndFetchDocument(title: string, jurisdiction: string): Promise<string | null> {
  ...
  async searchByKeywords(keywords: string[], jurisdiction: string): Promise<string[]> {
